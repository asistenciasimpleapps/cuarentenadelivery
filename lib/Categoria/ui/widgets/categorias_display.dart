...
import 'package:cuarentenadelivery/Producto/ui/screens/productos_display_screen.dart';
...
class _CategoriasDisplayState extends State<CategoriasDisplay> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Categoria> categorias = [
      ...
      Categoria(name: "Bebidas", productos: [], urlImage: "https://cdn.pixabay.com/photo/2016/12/06/18/27/milk-1887237_640.jpg"),
    ];
    ...
    return MostrarCategorias(buttonCategorias: buttonCategorias);
  }

  Widget MostrarCategorias({List<Widget> buttonCategorias}){
      ...
      children: [
        Row(
          ...
          children: [
            ...
            ButtonWhite(
              title: "Tipo de Vista",
              subText: widget.sesion.vista != null ? widget.sesion.vista['name'] : "PEQUEÑA",
    ...
    return InkWell(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(
          builder: (BuildContext context) => ProductosDisplayScreen(categoria: categoria.name,),
        ));
      },
      child: Container(
